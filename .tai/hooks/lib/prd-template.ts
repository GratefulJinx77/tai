/**
 * PRD Template Generator for TAI
 *
 * Shared PRD template used for work tracking.
 * Generates PRD files matching the frontmatter schema expected by the work system.
 */
