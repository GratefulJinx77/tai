...
- **Built-in agents** (`.tai/agents/*.md`): Use this format for the persona section
- **Custom agents** (`.tai/agents/custom/*.md`): Use this format for the entire file
...
|--------|-------------------------|-------------------------------|
| Location | `.tai/agents/` | `.tai/agents/custom/` |
