...
**What happens:**
1. Run `bun run .tai/skills/agents/Tools/ComposeAgent.ts` for EACH agent
...
- Composition tool: `.tai/skills/agents/Tools/ComposeAgent.ts`

---

## Named Agent Architecture

- **Location**: Individual agent files in `.tai/agents/*.md`
