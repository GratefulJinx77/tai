...
- World models must exist at `.tai/memory/research/WorldModels/`
...
```
Check .tai/memory/research/WorldModels/ for all 11 model files.
...
Read all 11 model files from `.tai/memory/research/WorldModels/`.
