...
- Model template at `.tai/skills/WorldThreatModelHarness/ModelTemplate.md`
...
```
Read .tai/memory/research/WorldModels/INDEX.md (if exists)
...
Save to: `.tai/memory/research/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `.tai/memory/research/WorldModels/INDEX.md`:
