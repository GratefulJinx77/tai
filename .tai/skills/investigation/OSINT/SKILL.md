...
`.tai/config/skill-customizations/OSINT/`
...
```
.tai/memory/state/work/$(jq -r '.work_dir' .tai/memory/state/current-work.json)/YYYY-MM-DD-HHMMSS_osint-[target]/
```

**Archived reports:**
```
.tai/memory/research/YYYY-MM/[target]-osint/
```
