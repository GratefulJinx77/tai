...
```
.tai/memory/state/work/$(jq -r '.work_dir' .tai/memory/state/current-work.json)/YYYY-MM-DD-HHMMSS_due-diligence-[company]/
  phase1-domains.md
  phase2-technical.md
  phase3-research.md
  phase4-vetting.md
...
.tai/memory/research/YYYY-MM/[company]-due-diligence/
