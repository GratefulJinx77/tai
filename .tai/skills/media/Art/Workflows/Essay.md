...
```bash
Read .tai/skills/media/Art/SKILL.md
```
...
bun run .tai/skills/media/Art/Tools/Generate.ts \
...
bun .tai/tools/RemoveBg.ts /path/to/output.png

# Or batch process multiple images
bun .tai/tools/RemoveBg.ts image1.png image2.png image3.png
```

**See:** `.tai/skills/media/Art/Workflows/BackgroundRemoval.md` for full documentation.
...
3. EMOTION → Match to register in .tai/aesthetic.md
