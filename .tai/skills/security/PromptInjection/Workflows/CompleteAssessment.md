...
**Save to:**
```
.tai/memory/history/research/YYYY-MM-DD_[client]-recon/
...
```
.tai/memory/history/research/YYYY-MM-DD_[client]-direct-injection/
├── findings.md
...
**Document findings in:**
```
.tai/memory/history/research/YYYY-MM-DD_[client]-indirect-injection/
├── findings.md
├── poisoned-documents/
├── test-web-pages/
...
```
.tai/memory/history/research/YYYY-MM-DD_[client]-multistage/
...
**Document in:**
```
.tai/memory/history/research/YYYY-MM-DD_[client]-defenses/
...
**Deliverables:**
```
.tai/memory/history/research/YYYY-MM-DD_[client]-final-report/
