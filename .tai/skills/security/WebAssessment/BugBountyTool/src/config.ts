...
export const CONFIG = {
  ...
  // Local paths
  paths: {
    root: '.tai/skills/hacking/bug-bounties',
    state: '.tai/skills/hacking/bug-bounties/state.json',
    cache: '.tai/skills/hacking/bug-bounties/cache',
    logs: '.tai/skills/hacking/bug-bounties/logs',
  },
