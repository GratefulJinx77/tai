...
import { insertNewsletterContent } from '.tai/skills/utilities/Parser/db';
...
- For traditional PDF extraction (text-only), see `.tai/skills/documents/pdf/SKILL.md`
- For PDF form filling, see `.tai/skills/documents/pdf/forms.md`
- For parser integration, see `.tai/skills/utilities/Parser/SKILL.md`
- For newsletter database schema, see `.tai/context/databases/newsletter/schema.sql`
