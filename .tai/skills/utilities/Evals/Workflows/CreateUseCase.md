...
```bash
mkdir -p .tai/skills/utilities/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `.tai/skills/utilities/Evals/UseCases/<name>/config.yaml`:
...
Create `.tai/skills/utilities/Evals/UseCases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `.tai/skills/utilities/Evals/UseCases/<name>/test-cases/`:
...
Create `.tai/skills/utilities/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run .tai/skills/utilities/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la .tai/skills/utilities/Evals/UseCases/<name>/

# Validate config
bun run .tai/skills/utilities/Evals/EvalServer/cli.ts use-case show <name>
```
...
bun run .tai/skills/utilities/Evals/EvalServer/cli-run.ts \
  --use-case <name> \
  --test-id 001-basic \
  --verbose
```
