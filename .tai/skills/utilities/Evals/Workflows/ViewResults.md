...
bun run .tai/skills/utilities/Evals/EvalServer/cli.ts results \
  --use-case <name> \
  --latest
```
...
bun run .tai/skills/utilities/Evals/EvalServer/cli.ts report \
  --run-id <run-id> \
  --output .tai/skills/utilities/Evals/Results/<use-case>/<run-id>/report.md
```
...
bun run .tai/templates/Tools/RenderTemplate.ts \
  -t Evals/Report.hbs \
  -d .tai/skills/utilities/Evals/Results/<use-case>/<run-id>/results.yaml \
  -o .tai/skills/utilities/Evals/Results/<use-case>/<run-id>/report.md
```
...
```bash
cd .tai/skills/utilities/Evals/EvalServer
...
```bash
bun run .tai/skills/utilities/Evals/EvalServer/cli.ts compare \
  --run-a <run-id-1> \
  --run-b <run-id-2>
```
...
```bash
bun run .tai/skills/utilities/Evals/EvalServer/cli.ts trend \
  --use-case <name> \
  --days 30
```
