...
```bash
# Check prompts exist
ls .tai/skills/utilities/Evals/UseCases/<name>/prompts/
...
Create `.tai/skills/utilities/Evals/UseCases/<name>/comparisons/<comparison-name>.yaml`:
...
bun run .tai/templates/Tools/RenderTemplate.ts \
  ...
  -d .tai/skills/utilities/Evals/UseCases/<name>/comparisons/<name>.yaml \
  -o .tai/skills/utilities/Evals/UseCases/<name>/comparisons/<name>-setup.md \
  --preview
```
