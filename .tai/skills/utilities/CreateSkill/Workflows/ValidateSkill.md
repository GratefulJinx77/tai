...
### Skill Directory
```bash
ls .tai/skills/ | grep -i [skillname]
```
...
```bash
bun .tai/skills/[SkillName]/Tools/[ToolName].ts --help
```
...
```bash
grep -l "Intent-to-Flag" .tai/skills/[SkillName]/Workflows/*.md
```
...
**Reference:** `.tai/docs/architecture.md`
