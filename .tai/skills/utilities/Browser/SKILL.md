...
`.tai/USER/SKILLCUSTOMIZATIONS/Browser/`
...
**Headless by default.** All automation runs headless. When the user says "show me", open the URL in their preferred browser from `.tai/USER/TECHSTACKPREFERENCES.md`:
...
**Agent definitions:** `.tai/agents/BrowserAgent.md` and `.tai/agents/UIReviewer.md`
