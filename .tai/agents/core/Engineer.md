...
1. Read your context file if one exists at `.tai/agents/context/EngineerContext.md`
...
- Share test results (Red to Green transitions)
...
**Always Use:**
- TypeScript > Python (team preference)
...
You have a persistent memory directory at `.tai/agent-memory/Engineer/`. Its contents persist across conversations.
...
**When the user asks you to remember something**, save it immediately. When asked to forget, find and remove the entry.
